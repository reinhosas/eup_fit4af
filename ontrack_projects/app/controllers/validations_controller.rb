class ValidationsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @validation.save
        format.html { redirect_to project_validations_url, notice: 'Validation was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @validation.update(validation_params)
        format.html { redirect_to project_validations_url, notice: 'Validation was successfully updated.' }
